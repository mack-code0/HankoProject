...
export default function Home() {
    ...
    const getArrayField = async () => {
        ...
        try {
            ...
            console.error('Error getting array field: ', error);
        } finally {
    ...
    return <Container className="p-8 h-screen">
        ...
        <AddNote getArrayField={getArrayField} open={addNote} toggle={toggleAddNote} />
        ...
        <div className="mt-20 space-y-10 pb-20">
            {homeState.isLoading
                ...
                : homeState.data.length < 1
                    ? <NoNote />
                    : homeState.data.map((note: any, idx) =>
                        <NoteRow
